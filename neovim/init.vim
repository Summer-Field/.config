...
let g:snips_author = 'Summer-Field'
...
augroup calendar-mappings
	...
	autocmd FileType calendar nmap <buffer> k <Plug>(calendar_right)
	...
	autocmd FileType calendar nmap <buffer> <c-k> <Plug>(calendar_move_right)
...
require'nvim-treesitter.configs'.setup {
  ensure_installed = {"typescript", "dart", "java", "go", "c", "yaml", },     -- one of "all", "language", or a list of languages
  highlight = {
    enable = true,              -- false will disable the whole extension
    disable = { "c", "rust" },  -- list of language that will be disabled
		additioinal_vim_regex_highlighting = false,
  },
}
EOF
