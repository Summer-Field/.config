...
#
alias vim="nvim"
# the setting of ranger
alias ra="ranger"
# the setting of lazygit
alias lg='lazygit'
# the setting of kubernetes
alias k='kubectl'
# kubectl get ...
...
alias devbox="ssh xiaye.field@10.248.168.74"
# quick edit .zshrc
alias ezr="vim ~/.zshrc"
# fzf's dragula theme
...
# grafana-cli
PATH=$PATH:/usr/local/Cellar/grafana/8.2.5/bin
# typora
...
# config for devstat installation on mac
# GOPATH=$HOME/dev/go; export GOPATH
# PATH=$PATH:$GOPATH/bin; export PATH
GOAPTH=~/go
# tencent cloud server
alias server="ssh field@124.222.95.180"
