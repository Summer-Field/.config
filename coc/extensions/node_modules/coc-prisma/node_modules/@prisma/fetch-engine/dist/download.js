...
const utimes = util_1.promisify(fs_1.default.utimes);
...
async function download(options) {
    ...
    const binaryJobs = flatMap_1.flatMap(Object.entries(opts.binaries), ([binaryName, targetFolder]) => opts.binaryTargets.map((binaryTarget) => {
        ...
        const targetFilePath = binaryName === BinaryType.libqueryEngine
            ? path_1.default.join(targetFolder, get_platform_1.getNodeAPIName(binaryTarget, 'fs'))
