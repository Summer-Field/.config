...
export declare function convertDocumentTextToTrimmedLineArray(document: TextDocument): Array<string>;
...
export declare function getBlockAtPosition(line: number, lines: Array<string>): Block | void;
