...
function getSuggestionForModelBlockAttribute(block, lines) {
    ...
    // create deep copy
    let suggestions = (0, klona_1.klona)(completionUtil_1.blockAttributes);
...
function getSuggestionForSupportedFields(blockType, currentLine, currentLineUntrimmed, position) {
    let suggestions = [];
...
//   )
// }
function getSuggestionsForAttribute({ attribute, wordsBeforePosition, untrimmedCurrentLine, lines, block, position, document, }) {
    ...
    if (attribute === '@relation') {
        ...
        if (wordsBeforePosition.some((a) => a.includes('@@unique'))) {
            ...
            blockAtrributeArguments = (0, completionUtil_1.givenBlockAttributeParams)('@@index');
        }
        if (blockAtrributeArguments.length) {
            ...
            if (wordsBeforePosition.some((a) => a.includes('@unique'))) {
                fieldAtrributeArguments = (0, completionUtil_1.givenFieldAttributeParams)('@unique');
            }
            else if (wordsBeforePosition.some((a) => a.includes('@id'))) {
                fieldAtrributeArguments = (0, completionUtil_1.givenFieldAttributeParams)('@id');
            }
            else if (wordsBeforePosition.some((a) => a.includes('@index'))) {
                fieldAtrributeArguments = (0, completionUtil_1.givenFieldAttributeParams)('@index');
            }
