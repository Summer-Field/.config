...
function assertLinting(expected, fixturePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const diagnosticsResults = yield MessageHandler_1.handleDiagnosticsRequest(document, binPathPrismaFmt);
...
suite('Linting', () => {
    ...
    test('Missing argument', () => __awaiter(void 0, void 0, void 0, function* () {
        yield assertLinting([
            {
    ...
    test('Wrong type', () => __awaiter(void 0, void 0, void 0, function* () {
        yield assertLinting([
            {
