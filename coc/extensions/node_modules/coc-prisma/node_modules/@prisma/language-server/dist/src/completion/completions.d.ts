...
export declare function getSuggestionForNativeTypes(foundBlock: Block, wordsBeforePosition: string[], document: TextDocument, lines: string[]): CompletionList | undefined;
export declare function getSuggestionForFieldAttribute(block: Block, currentLine: string, lines: string[], wordsBeforePosition: string[], document: TextDocument): CompletionList | undefined;
 ...
 */
export declare function getSuggestionForFirstInsideBlock(blockType: BlockType, lines: Array<string>, position: Position, block: Block): CompletionList;
...
export declare function getSuggestionForSupportedFields(blockType: BlockType, currentLine: string, currentLineUntrimmed: string, position: Position): CompletionList | undefined;
export declare function getTypesFromCurrentBlock(lines: Array<string>, block: Block, position?: Position): Map<string, number[]>;
export declare function getSuggestionsForInsideRoundBrackets(untrimmedCurrentLine: string, lines: Array<string>, document: TextDocument, position: Position, block: Block): CompletionList | undefined;
