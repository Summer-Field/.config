...
export declare function getSuggestionsForInsideAttributes(untrimmedCurrentLine: string, lines: Array<string>, document: TextDocument, position: Position, block: Block, binPath: string): CompletionList | undefined;
