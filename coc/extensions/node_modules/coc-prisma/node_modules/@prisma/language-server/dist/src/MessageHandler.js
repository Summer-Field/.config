...
function handleDocumentFormatting(params, document, onError) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const formatted = (0, format_1.default)(options.tabSize, document.getText(), onError);
...
function handleCompletionRequest(params, document) {
    ...
    if ((context === null || context === void 0 ? void 0 : context.triggerKind) === vscode_languageserver_1.CompletionTriggerKind.TriggerCharacter) {
        switch (context.triggerCharacter) {
            ...
            case '"':
                return (0, completions_1.getSuggestionForSupportedFields)(foundBlock.type, lines[position.line], currentLineUntrimmed, position);
            case '.':
