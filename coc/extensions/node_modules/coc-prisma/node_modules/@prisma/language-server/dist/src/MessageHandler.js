...
function handleDocumentFormatting(params, document, binPath, onError) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return format_1.default(binPath, options.tabSize, document.getText(), onError).then((formatted) => [vscode_languageserver_1.TextEdit.replace(util_1.fullDocumentRange(document), formatted)]);
    });
}
    ...
    switch (foundBlock.type) {
        case 'model':
            ...
            if (completions_1.isInsideAttribute(currentLineUntrimmed, position, '()')) {
                return completions_1.getSuggestionsForInsideAttributes(currentLineUntrimmed, lines, document, position, foundBlock, binPath);
            }
            // check if type
            if (!completions_1.positionIsAfterFieldAndType(position, document, wordsBeforePosition)) {
